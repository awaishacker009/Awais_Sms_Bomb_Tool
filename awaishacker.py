...
async def main():
    ...
    # os.system("termux-open-url https://whatsapp.com/channel/0029VbBzlMlIt5rzSeMBE922")

    while True:
        clear()
        # Simple Header
        print("\033[1;32m" + "━"*45)
        print("\033[1;37m        🚀  \033[1;31mAWAIS_DEVIL ATTACKER TOOL\033[1;37m  🚀")
        print("\033[1;32m" + "━"*45)
        print("\033[1;37m  DEVELOPER : \033[1;33mAB AWAIS | MAYO")
